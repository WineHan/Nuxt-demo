        ...
        <div class="main-kv">
          ...
          <div class="form-group">
            ...
            <div class="select-group">
              ...
              <wherebySelectCityList
                v-if="whereByStore.showCityFilter"
                :where-by-option="whereByStore.cityData"
              />
          ...
          >
            ...
            <div class="card-body">
              ...
              <div class="product-content">
                <client-only>
                  <p class="product-title">{{ $t("product") }}</p>
                </client-only>
...
if (whereByStore.showCityFilter) {
  await whereByStore.getCityData();
}
